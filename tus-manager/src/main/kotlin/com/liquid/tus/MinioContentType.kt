...
object MinioContentType {
    fun contentType(s: String): String {
        return when (s) {
            "001" -> "application/x-001"
            "301" -> "application/x-301"
            "323" -> "text/h323"
            "906" -> "application/x-906"
            "907" -> "application/x-907"  // 更标准的表示
            "class", "java" -> "text/x-java-source"  // 更标准的 MIME 类型
            "dwf" -> "model/vnd.dwf"  // 正确的顶级类型
            // 修正 PowerPoint 相关的 MIME 类型
            "pot" -> "application/vnd.ms-powerpoint"
            "ppa" -> "application/vnd.ms-powerpoint"
            "pps" -> "application/vnd.ms-powerpoint"
            "ppt" -> "application/vnd.ms-powerpoint"
            // 修正其他不规范的类型
            "mpd", "mpp", "mpt", "mpx" -> "application/vnd.ms-project"
